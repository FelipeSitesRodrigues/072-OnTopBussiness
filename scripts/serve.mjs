/**
 * Servidor estático de dist/ em http://localhost:3072, sem cache (copiado do 067).
...
const PORTA = Number(process.argv[2] || 3072)
const TIPOS = {
...
createServer(async (req, res) => {
  try {
    ...
    // URL limpa, como o cleanUrls da Vercel: /politica-de-privacidade → .html
